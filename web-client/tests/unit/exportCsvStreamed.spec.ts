...
describe('exportCsvStreamed geometry expansion', () => {
  ...
  describe('Geometry expansion validation', () => {
    it.skip('should compare expanded GEO coordinates with PLAIN file coordinates', () => {
  ...
  describe('Integration test placeholder', () => {
    it.skip('should export atl03x-surface_TEST_small_GEO.parquet with expanded geometry', () => {
