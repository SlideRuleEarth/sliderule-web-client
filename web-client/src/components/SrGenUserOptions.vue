...
<template>
  <div class="sr-gen-user-options-container">
    ...
    <SrCheckbox
      ...
      :tooltipUrl="DOCS.apiReference.earthdataCmr"
    />
    ...
    <Fieldset class="sr-timeouts-fieldset" legend="Timeouts" :toggleable="true" :collapsed="false">
      <SrSwitchedSliderInput
        ...
        :tooltipUrl="DOCS.basicUsage.timeouts"
      />
      <SrSwitchedSliderInput
      ...
      <div class="sr-restore-timeout-defaults">
        <Button
          label="Restore Default Timeout behavior"
          @click="reqParamsStore.restoreTimeouts()"
        />
      </div>
    </Fieldset>
