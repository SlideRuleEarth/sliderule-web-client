  ...
  <div class="sr-beam-panel">
    ...
    <div class="sr-sc-orient-panel">
      <div class="checkbox-item">
        <Checkbox
          binary
          :inputId="'sc_orient' + SC_BACKWARD"
          v-model="globalChartStore.hasScBackward"
          size="small"
          @change="onUserToggledSc"
        />
      ...
      <div class="checkbox-item">
        <Checkbox
          binary
          :inputId="'sc_orient' + SC_FORWARD"
          v-model="globalChartStore.hasScForward"
          size="small"
          @change="onUserToggledSc"
        />
...
const handleValueChange = (_e: any) => {
  ...
  const gts = getGtsForSpotsAndScOrients(
    globalChartStore.selectedSpots,
    globalChartStore.getScOrients()
  )
