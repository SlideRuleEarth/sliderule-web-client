...
const boxes = [
  { id: 1, hide: false, name: "ICESat-2 Surface Elevations", description: "For all surface types", image: "/SrGround.webp" },
  { id: 2, hide: true,  name: "ICESat-2 Land Ice Sheet", description: "For ice sheets and glaciers", image: "/SrSeaIce.webp" },
  { id: 3, hide: false, name: "ICESat-2 Canopy Heights", description: "For land regions with vegetation", image: "/SrCanopy.webp" },
  { id: 4, hide: true,  name: "ICESat-2 Coastal Bathymetry", description: "For shallow water coastal regions", image: "/SrOcean.webp" },
  { id: 5, hide: true,  name: "ICESat-2 Geolocated Photons", description: "For raw photon cloud", image: "/SrNoise.webp" },
  { id: 6, hide: true,  name: "GEDI Aboveground Biomass Density", description: "For land regions with vegetation", image: "/SrCanopy.webp" },
  { id: 7, hide: true,  name: "GEDI Canopy Heights", description: "For geolocated elevation and height metrics", image: "/SrInlandWater.webp" },
  { id: 8, hide: true,  name: "GEDI geolocated Waveforms", description: "For raw waveform returns", image: "/SrGround.webp" },
];
