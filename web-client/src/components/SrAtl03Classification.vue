  ...
  <div class="sr-atl03-cnf-container">
    <div class="sr-atl03-cnf-header">
      <SrCheckbox
        ...
        :tooltipUrl="DOCS.icesat2.atl03Classification"
        v-model="reqParamsStore.enableAtl03Classification"
      />
    </div>
    <div class="sr-atl03-cnf-body">
      <SrSurfaceRefType :insensitive="!reqParamsStore.enableAtl03Classification" />
      <div class="sr-menu-label-wrapper">
        <SrLabelInfoIconButton
          label="Signal Confidence"
          tooltipText="Confidence level for photon selection"
        />
        <MultiSelect
