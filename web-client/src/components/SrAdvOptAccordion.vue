...
const SrAtl03Classification = defineAsyncComponent(async () => import('@/components/SrAtl03Classification.vue'));
...
const SrAncillaryFieldEditor = defineAsyncComponent(async () => import('@/components/SrAncillaryFieldEditor.vue'));
const SrSurfaceElevation = defineAsyncComponent(async () => import('@/components/SrSurfaceElevation.vue'));
const SrGranuleSelection = defineAsyncComponent(async () => import('@/components/SrGranuleSelection.vue'));
const SrGenUserPresets = defineAsyncComponent(async () => import('@/components/SrGenUserPresets.vue'));
const SrGenUserOptions = defineAsyncComponent(async () => import('@/components/SrGenUserOptions.vue'));
