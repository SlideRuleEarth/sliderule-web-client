    ...
    <Card>
      <template #title>
        <div class="sr-card-title-center">
          <SrElTitleEdit @mouseover="handleMouseOver" @mouseleave="handleMouseLeave" />
        </div>
      </template>
      ...
      <template #content>
        ...
        <Fieldset
          legend="Advanced Filter Control"
          class="sr-filter-panel"
          toggleable
          :collapsed="true"
        >
          <SrWhereClause />
          <div class="sr-cycles-legend-panel">
            ...
            <div class="sr-select-boxes">
              ...
              <component :is="cycleSelectComponent" v-bind="cycleSelectProps">
