    ...
    <div>
      ...
      <div class="sr-parm-row">
        <div style="display: flex; align-items: center; gap: 0.5rem">
          <Checkbox binary v-model="reqParamsStore.useAtl24Compact" size="small" />
          <SrCheckbox
            label="Compact"
      ...
      <div class="sr-parm-row">
        <Checkbox binary v-model="reqParamsStore.useAtl24Classification" size="small" />
      ...
      <div class="sr-parm-row">
        <Checkbox binary v-model="reqParamsStore.useAtl24ConfidenceThreshold" size="small" />
        <SrSliderInput
      ...
      <div class="sr-parm-row">
        <div style="display: flex; align-items: center; gap: 0.5rem">
          <Checkbox binary v-model="reqParamsStore.useAtl24InvalidKD" size="small" />
      ...
      <div class="sr-parm-row">
        <div style="display: flex; align-items: center; gap: 0.5rem">
          <Checkbox v-model="reqParamsStore.useAtl24InvalidWindspeed" binary size="small" />
      ...
      <div class="sr-parm-row">
        <div style="display: flex; align-items: center; gap: 0.5rem">
          <Checkbox binary v-model="reqParamsStore.useAtl24LowConfidence" size="small" />
      ...
      <div class="sr-parm-row">
        <div style="display: flex; align-items: center; gap: 0.5rem">
          <Checkbox binary v-model="reqParamsStore.useAtl24Night" size="small" />
      ...
      <div class="sr-parm-row">
        <div style="display: flex; align-items: center; gap: 0.5rem">
          <Checkbox binary v-model="reqParamsStore.useAtl24SensorDepthExceeded" size="small" />
      ...
      <div class="sr-atl24-ancillary-fields">
        ...
        <div v-if="reqParamsStore.atl24AncillaryFields.length > 0" class="sr-ancillary-list">
          <span
            class="sr-pill"
            v-for="(field, idx) in reqParamsStore.atl24AncillaryFields"
            :key="idx"
          >
            {{ field }}
            <Button
...
function addAncillaryField() {
  ...
  if (trimmed && !reqParamsStore.atl24AncillaryFields.includes(trimmed)) {
