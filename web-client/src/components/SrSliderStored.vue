    ...
    <div class="sr-slider-input-wrapper">
        <div class="sr-slider-col">
            ...
            <div class="sr-slider-input-row">
                <Slider v-model="modelValueComputed" :name="sliderName" :min="min" :max="max" :step="sliderStepSize" class="sr-slider" :disabled="props.insensitive" />
...
<script setup lang="ts">
    ...
    const modelValueComputed = computed({
        get() {
            ...
            //console.log('SrSliderStored:', props.label, 'get:', menuItem);
            return item; // calling the getter function
        },
        set(value) {
            //console.log('SrSliderStored:', props.label, 'set:', value)
    ...
    const formattedValue = computed({
        get: () => 
        {
            if (props.insensitive) {
                ...
                return new Intl.NumberFormat('en-US', { minimumFractionDigits: props.decimalPlaces, maximumFractionDigits: props.decimalPlaces }).format(modelValueComputed.value);
            }
        },
        set: (val) => {
...
.sr-slider-input-text {
    width: 2em; /* Adjust as needed for 2 digits */
    text-align: right;
    padding: 0.25rem;
    font-size: small;
