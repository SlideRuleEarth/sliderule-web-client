...
const defaultMaxIterations = () => {
  return useSlideruleDefaults().getNestedMissionDefault<number>(
...
const ccvDefaultMaxIterations = () => {
  return reqParamsStore.getUseMaxIterations() !== undefined
    ? reqParamsStore.getUseMaxIterations()
    : false
}

const ccvDefaultMinWindowHeight = () => {
  return reqParamsStore.getUseMinWindowHeight() !== undefined
    ? reqParamsStore.getUseMinWindowHeight()
    : false
}

const ccvDefaultMaxRobustDispersion = () => {
  return reqParamsStore.getUseMaxRobustDispersion() !== undefined
    ? reqParamsStore.getUseMaxRobustDispersion()
    : false
}
  ...
  <div class="sr-surface-elevation-container">
    <div class="sr-surface-elevation-header">
      <SrCheckbox
        ...
        :tooltipUrl="DOCS.icesat2.atl06SrParameters"
