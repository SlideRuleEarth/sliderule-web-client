...
const { data, error, importJson } = useJsonImporter(ICESat2ParamsSchema)
...
<template>
  <div class="p-4">
    ...
    <div v-if="data" class="text-green-600 mt-3">✅ JSON is valid.</div>
    <div v-else-if="error" class="text-red-600 mt-3 whitespace-pre-line">❌ {{ error }}</div>
