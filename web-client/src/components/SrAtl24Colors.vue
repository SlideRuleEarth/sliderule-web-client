<template>
  <div class="sr-legend-box">
    <Fieldset
      ...
      :collapsed="false"
    >
      <div v-for="option in atl24ClassOptions" :key="option.value" class="legend-item">
        <div
          class="color-box"
          :style="{
            backgroundColor: atl24ClassColorMapStore.getColorForAtl24ClassValue(option.value)
          }"
        ></div>
...
const _emit = defineEmits(['restore-atl24-color-defaults-click', 'atl24ClassColorChanged'])
