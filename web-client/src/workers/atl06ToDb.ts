...
import { updateExtremes,checkDoneProcessing,sendAbortedMsg,sendProgressMsg,sendServerMsg,sendStartedMsg,sendErrorMsg, type ExtHMean, type ExtLatLon } from '@/workers/workerUtils';
