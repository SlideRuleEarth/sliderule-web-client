  ...
  return defineStore(`gradientColorMapStore-${reqIdStr}`, () => {
    ...
    function updateGradientColorMapValues(): void {
      try {
        ...
        logger.error('updateGradientColorMapValues error', {
          reqIdStr,
    ...
    function restoreDefaultGradientColorMap(): void {
      const plotConfigStore = usePlotConfigStore()
      plotConfigStore.restoreDefaults()
      selectedGradientColorMapName.value = plotConfigStore.defaultGradientColorMapName
      numShadesForGradient.value = plotConfigStore.defaultGradientNumShades
    }
    ...
    watch([selectedGradientColorMapName, numShadesForGradient], updateGradientColorMapValues, {
      immediate: true
    })
